...
//             comp.onToggleClick()
//             expect(comp.isToggleOn).toBeTruthy(); //  Not sure if this was the assert here , please fix this when fixing the unit tests
//        });
...
//             expect(comp.isToggleOn).toBeFalsy(); //  Not sure if this was the assert here , please fix this when fixing the unit tests
//        });
